<nav class="navbar navbar-inverse navbar-expand-lg bg-light fixed-top " style="border-bottom:5px solid #e91e63" role="navigation-demo">
            <div class="container">
              ...
              <div class="navbar-translate">
                <a class="navbar-brand text-rose" href="vote_shirt.php"><i class="fas fa-tshirt"></i><i class="fas fa-vote-yea"></i> YRC Vote Shirt 2021 </a>
              ...
              <div class="collapse navbar-collapse">
                <ul class="navbar-nav ml-auto" >
                  <li class="nav-item">
                    <a href="vote_shirt.php" class="nav-link" style="font-size: 15px;">
