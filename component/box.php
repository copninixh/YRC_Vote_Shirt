<div class="col-xl-4 col-lg-5 mt-5 wow fadeInLeft" >
                <div class="col-md-12 bg-white py-4" style="border-radius: 7px">
                    <p class="text-center"><img src="assets/img/logo2.png" class="img-fluid w-75" alt=""></p>
                    ...
                    <?php
                        ...
                        if($numcheck == '1'){
                    ?>
                        <a href="#" class="btn btn-success w-100 btn-sm" style="font-size: 15px;"><i class="fas fa-vote-yea"></i> เลือกเรียบร้อยแล้ว</a>
                    <?php }else{?>
                    ...
                    <?php if($_SESSION['s_status'] == 'A'){ ?>
                        ...
                        <div class="list-group ">
                            ...
                            <a href="manage_shirt.php" class="list-group-item list-group-item-action" style="background-color: #e9ecef;"><i class="fas fa-tshirt"></i> บริหารจัดการเสื้อ</a>
                            <a href="result_score.php" target="_blank" class="list-group-item list-group-item-action" style="background-color: #e9ecef;"><i class="fas fa-chart-bar"></i> รายงานผลลงคะแนนเสียง</a>
