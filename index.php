...
<body >
    <img class="wave d-none d-xl-block d-lg-block wow fadeInLeft" src="assets/img/wave2.png">
    ...
    <div class="container wow" align="right">
   
        <div class="col-xl-6 col-lg-5 mt-xl-4 text-center d-none d-sm-block">
            <br>
            <br>
            <div class="col-xl-12">      
        ...
        <div class="col-xl-6 col-lg-5 text-center bg-white" style="border-radius: 10px;" align="center">
                ...
                <h3 class="text-rose text-center">ระบบโหวตเสื้อคณะสี  <br class="d-none d-lg-block d-xl-none">ประจำปีการศึกษา 2564</h3>
                ...
                <div class="col-xl-12 py-4">
                        <form method="post" action="process/loginact.php">
                            ...
                            <button type="submit" name="submit" class="btn btn-success btn-md w-100" style="font-size:16px">เข้าสู่ระบบ</button>
                        </form>
                        <p align="center"><a href="result_score.php">รายงานผลโหวต</a></p>
                        <hr>
                        <p style="color: #929292">©<?php echo date("Y") ?> All Right Reserved Kampanart.Ch , Ratchanon.Mo , Kru Viratchai.Ju <br> Youth Computer Gen 9 Yupparaj Wittayalai School</p>
                </div>       
        </div>
