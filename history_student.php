                    ...
                    <div class="container">
                        ...
                        <?php 
                            if(!$_SESSION['s_id']){
                                ...
                                echo '<a href="vote_shirt.php" class="btn btn-primary btn-sm w-50">กลับหน้าหลัก</a>';
                            }
                        ?>
                        ...
                        <table class="table" id="table_id">
                            ...
                            <?php }?>
                                ...
                                <td><a href="process/delete_result.php?id=<?php echo $row[0] ?>" class="btn btn-danger" style="font-size: 16px;">ลบ</a></td>
